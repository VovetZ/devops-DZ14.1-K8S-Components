...
- ВАРИАНТ 4.Все компоненты на общих нодах.Так же необходимо выбрать размер и количество узлов (нод) для кластера, учитывая следующие факторы:
...
**Итого (с округлением в большую сторону): 7 нод, 27 CPU core, 60 Gb RAM**
